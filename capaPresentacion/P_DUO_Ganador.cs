...
{
    public partial class P_DUO_Ganador : Form
    {
        public P_DUO_Ganador(E_focusedBible Configuracion)
        {
        ...
        void SetFinalResults()
        {
            ...
            lab_ScoreNum2.Text = objEntidad.finalResultsDUO[1, 0];
            ...
            lab_tiempo_1.Text = objEntidad.finalResultsDUO[0, 2] + " s";
            lab_tiempo_2.Text = objEntidad.finalResultsDUO[1, 2] + " s";
