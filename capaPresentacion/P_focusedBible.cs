...
{
    public partial class P_focusedBible : Form
    {
                
        public P_focusedBible(string player1 = "Player One", string player2 = "Player Two",
...
//                OpenGameSettings();
        ...
        */
        ...
        {
            Gamesettings.numRounds = Rounds;
            Gamesettings.difficulty = difficulty;
            Gamesettings.time2Answer = time2Answer;            

            // mostrar los nombres que estan jugando
            Gamesettings.tbx_Group1.Text = lab_Player1.Text;
            Gamesettings.tbx_Group2.Text = lab_Player2.Text;
        ...
        */
        ...
        private void btn_goToMain_Click(object sender, EventArgs e)
        {
            Timer_2Answer.Stop();
            sonido.Stop();
            this.DialogResult = DialogResult.OK; //Esto cierra la ventana del juego y va a Main
        }
    }
}
